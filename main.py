...
# ===== إعدادات عامة =====
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "change-me")  # غيّرها في Render → Environment
FLASK_SECRET   = os.getenv("FLASK_SECRET",   "please-change")  # غيّرها في Render → Environment
...
if __name__ == "__main__":
    # Render يشغّله عندك بـ "python main.py"
